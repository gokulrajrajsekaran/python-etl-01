...
def load_incremental_productlines():
    conn = get_connection()
    cur = conn.cursor()
    ...
    try:
        ...
        print("Updated existing productlines where data changed.")
        ...
        conn.commit()
        print("Inserted new productline records successfully.")
